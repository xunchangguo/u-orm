...
public interface IdentifierGeneratorFactory {
	 ...
	 * @param keygenertator @see org.uorm.orm.annotation.KeyGenertator
	 * @return
	 * @throws Exception 
	 */
	...
	/**
	 * get the class that will be used as the {@link IdentifierGenerator} for the given keygenertator
	 * @param keygenertator @see org.uorm.orm.annotation.KeyGenertator
	 * @return
	 */
