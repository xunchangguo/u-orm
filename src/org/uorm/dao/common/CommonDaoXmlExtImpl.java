 ...
 * 2013-1-31       郭训长            创建<br/>
 */
public class CommonDaoXmlExtImpl extends CommonDaoImpl implements ICommonDaoXmlExt {
	private static final Logger logger = LoggerFactory.getLogger(CommonDaoXmlExtImpl.class);
	...
	private String rootName = _DEFAULT_ROOT_NAME;
	private String itemName = _DEFAULT_ITEM_NAME;
	 ...
	 * @param xmlReader
	 */
	public CommonDaoXmlExtImpl(ConnectionFactory connectionFactory, IXmlReader xmlReader) {
		super(connectionFactory);
