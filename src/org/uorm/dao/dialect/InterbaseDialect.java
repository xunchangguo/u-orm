...
public class InterbaseDialect implements Dialect {
	...
	public String getLimitString(String query, int offset, int limit) {
		return new StringBuffer( query.length()+15 )
		.append(query)
		.append(" rows ").append(limit)
		.append(" to ").append(offset)
		.toString();
	}
	...
	public String getSequenceNextValString(String tablename) {
		return "select " + getSelectSequenceNextValString( SequenceGenerator.getDefaultSequenceName(tablename) ) + " from RDB$DATABASE";
	}
